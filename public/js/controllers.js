 ...
 *
 */
function MainCtrl($scope, $http, $state, $ocLazyLoad, $rootScope) {



  // console.log($http, $scope, $state, $ocLazyLoad);
  // var string = '/login';
  // 
  /**
...
function navcontrol($scope) {
  $scope.getInclude = function () {
    var currentPath = window.location;
    if ((currentPath.hash).split('/')[2] == 'studentportal') {
      return "views/common/studentNavigation.html";
    } else if ((currentPath.hash).split('/')[2] == 'academics') {
      return "views/common/navigation.html";
